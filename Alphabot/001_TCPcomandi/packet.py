class Packet:
    ...
    def to_bytes(self):
        ...
        movimento_buffer= len(movimento_buffer).to_bytes(1, 'big')    #?big--> cifra più significativa come prima
        buffer = buffer + movimento_buffer + movimento_bytes

        durata_bytes = self.message.encode('utf-8')
